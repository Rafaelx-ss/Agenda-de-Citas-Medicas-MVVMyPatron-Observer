...
1. **TENER UN MOTOR COMO XAMPP O WAMP**
   - Descargar y instalar el motor de tu preferencia

### Instalación con XAMPP/WAMP

1. **Copiar proyecto a carpeta htdocs/www**

   ```
   C:\xampp\htdocs\Agenda-de-Citas-Medicas-MVVMyPatron-Observer
   ```
...
3. **Acceder desde navegador**
   ```
   http://localhost/Agenda-de-Citas-Medicas-MVVMyPatron-Observer
   ```
